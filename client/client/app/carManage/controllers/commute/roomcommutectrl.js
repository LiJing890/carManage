...
angular.module('carManageApp').controller('roomcommutectrl', ['$scope','$http','settingService', 'roomCheckServices','$rootScope','dialog',function($scope,$http,settingService, roomCheckServices,$rootScope,dialog){
	//LIST数据获取
	 $scope.roomlist=[];
	 $scope.freeroom="";
